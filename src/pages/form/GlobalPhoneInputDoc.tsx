    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-muted-foreground">
          国际手机号输入组件，左侧区号选择 + 右侧号码输入，内置越南（+84）和中国（+86）预设，支持自定义区号选项和验证规则。
        </p>
      </div>
...
/>`}
      ...
      <ComponentDemo
        ...
        code={`const options: CountryCodeOption[] = [
  { cc: "84", label: "+84", flag: "vn", phoneLength: 10 },
  { cc: "86", label: "+86", flag: "cn", phoneLength: 11 },
  {
    cc: "1",
...
/>`}
      ...
      <ComponentDemo
        ...
        code={`<EasyGlobalPhoneInput size="sm" ... />
<EasyGlobalPhoneInput size="default" ... />
<EasyGlobalPhoneInput size="lg" ... />`}
      >
        <SizeDemo />
      </ComponentDemo>
      ...
      <ComponentDemo
        ...
        code={`<EasyGlobalPhoneInput disabled cc="84" phone="0901234567" ... />`}
      >
        <DisabledDemo />
      </ComponentDemo>
